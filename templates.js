...
function fPentamino(pixels) {
    var p1 = {x: 93, y: 52, s1: "black", s2: "white"};
    pixels.addPixel(p1);
    var p2 = {x: 93, y: 53, s1: "black", s2: "white"};
    pixels.addPixel(p2);
    var p3 = {x: 92, y: 52, s1: "black", s2: "white"};
    pixels.addPixel(p3);
    var p4 = {x: 93, y: 51, s1: "black", s2: "white"};
    pixels.addPixel(p4);
    var p5 = {x: 94, y: 51, s1: "black", s2: "white"};
    pixels.addPixel(p5);
}
